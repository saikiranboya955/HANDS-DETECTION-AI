...
An interactive AI-powered hand tracking system that turns your hand gestures into stunning neon visuals and sound effects in real-time. Built using MediaPipe Hands, this project blends computer vision, creativity, and AR-like experiences in the browser.
